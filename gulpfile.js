...
const path = {
	...
	src: {
		...
		css:
			srcPath +
			'assets/scss/{style.scss,swiper-bundle.min.css,fancybox.css}',
		js:
			srcPath +
			'assets/js/{main.js,swiper-bundle.min.js,perfect-scrollbar.jquery.min.js,fancybox.js,clipboard.min.js}',
		images: srcPath + 'assets/images/**/*.{jpg,png,svg,ico,webp,gif,mp4}',
